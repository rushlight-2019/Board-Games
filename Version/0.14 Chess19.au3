...
Global $ver = "0.14 22 May 2019  Update FEN board"
...
#cs ----------------------------------------------------------------------------
	...
	0.15 23 May 2019  Store Move
	0.14 22 May 2019  Update FEN board
...
Func Game()
	...
	Do ;game loop
		...
		;Valid Move - Store in file to send.
...
EndFunc   ;==>Game
#CS INFO
	36488 V17 5/22/2019 11:24:06 PM V16 5/19/2019 1:08:18 PM V15 5/18/2019 12:03:12 PM V14 5/17/2019 9:26:45 AM
#CE
...
EndFunc   ;==>GetToPos
#CS INFO
	51287 V2 5/22/2019 11:24:06 PM V1 5/19/2019 1:08:18 PM
#CE

Func DoMove() ;Update FEN board.
	Local $pf

	DataOut($g_RankTo, $g_FileTo)
	DataOut($g_RankFrom, $g_FileFrom)

	If $g_Playing = $BLACK Then
		$g_RankTo = 7 - $g_RankTo
		$g_FileTo = 7 - $g_FileTo
		$g_RankFrom = 7 - $g_RankFrom
		$g_FileFrom = 7 - $g_FileFrom
	EndIf
	;To and From are not game layout

	$pf = $g_FEN[$g_RankFrom][$g_FileFrom]
	DataOut("FEN Piece", $pf)
	$g_FEN[$g_RankTo][$g_FileTo] = $pf
	$g_FEN[$g_RankFrom][$g_FileFrom] = $EMPTY

	DataOut($g_RankTo, $g_FileTo)
	DataOut($g_RankFrom, $g_FileFrom)
	;_ArrayDisplay($g_FEN, "FEN  white at 0,0")

	DataOut("Store moves here")
EndFunc   ;==>DoMove
#CS INFO
	45216 V6 5/22/2019 11:24:06 PM V5 5/17/2019 9:26:45 AM V4 5/14/2019 4:54:04 PM V3 5/14/2019 8:14:38 AM
#CE
...
EndFunc   ;==>ShowBG
#CS INFO
	46818 V6 5/22/2019 11:24:06 PM V5 5/19/2019 1:08:18 PM V4 5/18/2019 12:03:12 PM V3 5/17/2019 9:26:45 AM
#CE
...
Func UpdateBoard($Bottom) ; Who on Bottom will be at Bottom Left 0,0
	...
	;If $TESTING = False Then_ArrayDisplay($g_display, "Display playing, will be at 0,0")

EndFunc   ;==>UpdateBoard
#CS INFO
	134165 V11 5/22/2019 11:24:06 PM V10 5/19/2019 1:08:18 PM V9 5/18/2019 12:03:12 PM V8 5/18/2019 6:55:11 AM
#CE
...
Func FenBoard($o_sFen)
	...
	;If $TESTING = False Then_ArrayDisplay($g_FEN, "FEN  white at 0,0")
...
EndFunc   ;==>FenBoard
#CS INFO
	128367 V10 5/22/2019 11:24:06 PM V9 5/19/2019 1:08:18 PM V8 5/18/2019 12:03:12 PM V7 5/18/2019 6:55:11 AM
#CE
...
;~T ScriptFunc.exe V0.54a 15 May 2019 - 5/22/2019 11:24:06 PM
