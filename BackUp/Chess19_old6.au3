...
$c=False
		For $iFile = 0 To 7
			For $iRank = 0 To 7
				...
				$g_aDisplay[$iRank][$iFile] = GUICtrlCreatePic(@ScriptDir & "\images\empty", $iFile * 64, $iRank * 64, 64, 64)
...
if $iRank =4 then GUICtrlSetImage($g_aDisplay[$iFile][$iRank],@ScriptDir & "\images\brook.bmp")
