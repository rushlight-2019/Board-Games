...
For $iFile = 0 To 7
				...
				$g_aDisplay[$iRank][$iFile] = GUICtrlCreatePic(@ScriptDir & "\images\brook.bmp", $iFile * 64, $iRank * 64, 64, 64)
				...
				EndIf
				If $iRank = 4 Then GUICtrlSetImage($g_aDisplay[$iFile][$iRank], @ScriptDir & "\images\wrook.bmp")
				If $iRank = 5 Then GUICtrlSetImage($g_aDisplay[$iFile][$iRank], @ScriptDir & "\images\wKing.bmp")
			Next
			$c = Not $c
			pause()
		Next
